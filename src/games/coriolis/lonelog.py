...
def narrative_context_for_ai(
    ...
    *,
    ...
    return "Story so far in Coriolis (continue naturally):\n\n" + body


def log_roll(slot_id: str, label: str) -> None:
    _store().append_log(slot_id, f"d: {label}")
