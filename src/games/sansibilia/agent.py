"""San Sibilia agent graph nodes."""

from __future__ import annotations

from src.games.sansibilia.actions import SHORTCUT_IDS
...
def sansibilia_multi_node(state: dict) -> dict:
    game_id = state.get("game_id", GAME_SANSIBILIA)
    shortcut_id = state.get("shortcut_id") or "draw_day"
    ...
    user_message, answer, sources, _route = run_visit_shortcut(
        ctx,
        shortcut_id,
