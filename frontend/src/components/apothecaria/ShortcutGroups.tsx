...
const GROUPS: { title: string; ids: string[] }[] = [
  {
    title: "Patient",
    ids: ["start_patient", "draw_patient_type", "draw_ailment", "complete_potion", "potion_preview"],
  },
  {
    title: "Foraging",
    ids: ["change_locale", "forage_event", "hunt_reagent", "foraging_rules", "reagents_help"],
  },
  {
    title: "Calendar",
    ids: ["advance_week", "advance_downtime", "festival_prompts"],
  },
  {
    title: "Village & shop",
    ids: ["village_services", "shop_tools", "shop_upgrades", "buy_tool", "buy_upgrade"],
  },
  {
    title: "Mystery & familiar",
    ids: ["witch_clue", "draw_familiar_type", "draw_familiar_skill"],
  },
  {
    title: "Reference",
    ids: ["locales_help"],
